...
/// of world points. The full camera-frustum-to-ground fit lives in the shadow tweakers'
/// computeWorldToLightClipCascades(); these primitives are unit-testable in isolation.
