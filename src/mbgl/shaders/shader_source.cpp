...
{BuiltIn::ShadowDepthShader, "ShadowDepthShader"},
{BuiltIn::ShadowDepthInstancedShader, "ShadowDepthInstancedShader"},
{BuiltIn::FillExtrusionShadowShader, "FillExtrusionShadowShader"},
{BuiltIn::GroundShadowShader, "GroundShadowShader"},
...
{BuiltIn::ModelBloomShader, "ModelBloomShader"}
});
