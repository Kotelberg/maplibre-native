...
void MLNMapViewMetalImpl::createView() {
  ...
  // pass descriptor (see shaders/mtl/shader_program.cpp). On Apple TBDR GPUs the resolve
  // happens in tile memory, so the cost is small relative to the edge quality gained on thin
